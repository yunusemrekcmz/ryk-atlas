...
import { Search, Compass, GraduationCap, User, ArrowLeft, Star, Share2, FileText, Trophy, RotateCcw, Bot, ArrowUp } from 'lucide-react';
...
const AnatomyAtlasApp: React.FC = () => {
  ...
  // Alt Görünüm: Seçili Öğenin Detayı
  if (selectedItem) {
  ...
  // Alt Görünüm: Seçili Sistemin Detayı
  if (selectedSystem) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      {currentView === 'explore' && (
        <header className="bg-slate-900 border-b border-slate-800 p-5 sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-400">Anatomi artık cebinde</p>
            </div>
          </div>
        </header>
      )}
